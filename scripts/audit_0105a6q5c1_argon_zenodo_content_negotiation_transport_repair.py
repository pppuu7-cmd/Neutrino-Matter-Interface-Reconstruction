...
PREREG='cf3d7bebc1aae654ec09a78284c6f3162df4f9df'
...
def main():
    ...
    out={'gate':GATE,'preregistration_commit':PREREG,'git_sha':a.git_sha,'files':{},'explicit_accept_header_used':False,'scientific_content_inspected':False,'pseudo_data_generated':False,'likelihood_evaluated':False,'observed_bsm_residual_inspected':False,'systematic_monte_carlo_preregistration_permission_percent':0,'systematic_monte_carlo_execution_permission_percent':0,'observed_bsm_residual_permission_percent':0}
    ...
    for name,(url,size,emd5,esha) in FILES.items():
        try:
            req=urllib.request.Request(url,headers={'User-Agent':'NMIR-q5c1-byte-lock/1.0'})
    ...
    if transport_fail: cls='BLOCKED_0105A6Q5C1_ZENODO_DIRECT_TRANSPORT_FAILURE'
    elif mismatch: cls='FAIL_0105A6Q5C1_OFFICIAL_BYTE_IDENTITY_MISMATCH'
    else: cls='PASS_0105A6Q5C1_ARGON_OFFICIAL_FOUR_SEMANTIC_FILES_BYTE_LOCKED_NONDISCOVERY'
