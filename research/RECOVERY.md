...
Latest completed immutable record: `research/iterations/0080d_bl_cmb_conservative_excluded_geometry.md`, commit `9da3a5a0627a472815e1eabbec21df37672f5953`.
Current prospective gate: `research/prereg/0080e_bl_cosmology_scenario_semantics.md`, frozen commit `bfc19b82d3320e8b798090fdfc2e99c52602917c`.
`NMIR_READINESS: 94%`.
...
### 0080–0080d — cosmology/CMB chain
...
0080b `PASS_COSMOLOGY_B_L_CMB_AXIS_CALIBRATION`, immutable commit `5ed6fe12342fb07edefe1b80ed5cf893b7486d23`, run/job `34161277512/101863457667`, artifact `10032672039`: `log10(m_X/MeV)=0.014151317772708815*x-6.9932501456724525`, `log10(g_X)=-0.0329969798924973*y-2.6510803066554596`; frozen calibration tolerances passed.
0080c `PASS_COSMOLOGY_B_L_CMB_CONSERVATIVE_95CL_SEMANTICS`, immutable commit `755911fd5afcca77c3c0d54e7f41e1b6aa9b7462`, corrected run/job `34161487414/101864078212`, artifact `10032738989`, ZIP SHA256 `bcdef158881eec04c098014acfa934fb734638271c7aea265a0da3a3dd54e726`. Hard current-CMB exclusion is prospectively fixed as `Delta N_eff>=0.4` at 95% C.L. = light blue + dark blue; green is strongly disfavored only. Initial parser run is implementation-invalid false-negative, not scientific BLOCKED.

0080d **`PASS_COSMOLOGY_B_L_CMB_CONSERVATIVE_EXCLUDED_GEOMETRY`**, immutable commit `9da3a5a0627a472815e1eabbec21df37672f5953`; run/job `34161859886/101865153356`, artifact `10032854190`, artifact ZIP SHA256 `f00a461bb3780538d341c47b39b11ede9a4b5b34e928d679d2844c51db9d23bc`, raw JSON SHA256 `2d288fedc2da00da1a44e1536d0555bd5931a0052fbc48f29e4984bab2c66f97`. Exact native fills only: dark blue `(0,0.46666,0.733322)` and light blue `(0.199997,0.733322,0.933319)`; green excluded. Majorana: one valid component, area `48.332188584322665 decade^2`, refinement/symdiff `0`; Dirac: one valid component, area `45.129364149717375 decade^2`, refinement/symdiff `0`. Boundary controls are far below 0.02 pt. No raster/manual input or topology repair. This new reproducible finite-mass cosmology excluded-region family raises readiness 93% -> 94%.

Majorana and Dirac remain alternative scenario-conditioned outputs. 0080d does not authorize union/intersection or a scenario-independent cosmology exclusion.

## Current prospective gate — 0080e
`research/prereg/0080e_bl_cosmology_scenario_semantics.md`, frozen commit `bfc19b82d3320e8b798090fdfc2e99c52602917c`.

0080e must audit the primary TeX only to determine whether Majorana/Dirac are alternative model cases or whether the source explicitly prescribes a common combination/preference. No geometry composition or external neutrino-nature assumption is allowed. If source treats them as alternatives without combination rule, classify `PASS_COSMOLOGY_B_L_SCENARIO_CONDITIONAL_AUTHORITY` and keep two separate ledger branches.

## Current funnel state
- BSM/F8: 0080e is highest-value frozen gate.
...
## Exact next gate
Execute 0080e exactly as frozen at commit `bfc19b82d3320e8b798090fdfc2e99c52602917c`. Resolve primary Majorana/Dirac scenario semantics before any composition. A scenario-conditional PASS returns the funnel to the remaining missing 0071 external families rather than inventing one cosmology polygon; a source-authorized common-combination PASS may only authorize a separately preregistered composition gate.

## Critical guards
No raster/manual contour reading. No post-result convention factor, excluded-side assignment, scenario selection or threshold relaxation. No Asimov substitution for required observed likelihoods. No proportional splitting of grouped backgrounds. No cross-analysis response/template substitution without identity provenance. No finite-mass extrapolation of 0079a. No F9 multiplication of unvalidated gains.
